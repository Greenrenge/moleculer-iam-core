...
export const broker = new ServiceBroker(
  moleculer.createServiceBrokerOptions({
    ...
    _.defaultsDeep(
      {
        ...
        op: {
          ...
          issuer,
          discovery: {
            op_policy_uri: `https://qmit1201.notion.site/plco-cbb2d3dd69d845919c9cdc9fc75da2da`,
            op_tos_uri: `https://qmit1201.notion.site/plco-98bc009774dd4c48880439735a57e058`,
          ...
          app: {
            ...
            verifyEmail: {
              async send({ logger, ...args }) {
                ...
                try {
                  await broker.call(
                    "sports.notification.sendVerificationEmail",
                    args,
                  )
                } catch (err) {
                  logger.error(err)
            ...
            verifyPhone: {
              async send({ logger, ...args }) {
                ...
                try {
                  await broker.call(
                    "sports.notification.sendVerificationSMS",
                    args,
                  )
                } catch (err) {
                  logger.error(err)
