...
export class Identity implements OIDCAccount {
  ...
  public async claims(
    ...
    return this.adapter.getClaims(
      this.id,
      typeof scope === "string" ? scope.split(" ").filter((s) => !!s) : scope,
    )
  }
  ...
  public async updateClaims(
    ...
    await this.adapter.createOrUpdateClaimsWithValidation(
      this.id,
      claims,
      typeof scope === "string" ? scope.split(" ").filter((s) => !!s) : scope,
      false,
  ...
  public async updateMetadata(
    ...
    await this.adapter.createOrUpdateMetadata(
      this.id,
  ...
  public async updateCredentials(
    ...
    return this.adapter.createOrUpdateCredentialsWithValidation(
      this.id,
      credentials,
      transaction,
    )
  ...
  public async json(
    ...
    const [claims, metadata] = await Promise.all([
      this.claims(undefined, scope),
      this.metadata(),
    ])
    return {
      id: this.id,
